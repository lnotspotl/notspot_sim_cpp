# Notspot robot simulation - C++ version
...
If you are interested in the Python version, make sure to check [this](https://github.com/lnotspotl/notspot_sim_py) repository out.
